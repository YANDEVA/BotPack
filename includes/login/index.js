...
function makeLogin(jar, email, password, loginOptions, callback, prCallback) {
    return function(res) {
      ...
      console.log(co("[ DATABASE ]"), (cra("[ CONNECT ]")), `Logging in.`);
        return utils
            .post(
            ...
            .then(function(res) {
                ...
                if (
                  ...
                  console.log(co("[ DATABASE ]"), (cra("[ CONNECT ]")), 'You have login approvals turned on.');
                    var nextURL =
                                    ...
                                    continue: function submit2FA(code) {
                                        ...
                                        if (typeof code == "string") {
                                            ...
                                            utils
                                                ...
                                                .catch((ex) => {
                                                    //log.error("login", ex);
                                                  console.log(co("[ DATABASE ]"), (cra("[ CONNECT ]")), ex);
                                                    if (
                                                        callback === prCallback
                                                    ) {
                                                        prReject(ex);
...
function loginHelper(
    ...
    mainPromise
        ...
        .catch(function(e) {
          ...
          global.loading.error((cra("[ CONNECT ] ")) + e.error || e, "DATABASE");
